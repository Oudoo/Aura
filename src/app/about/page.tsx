    ...
    <main className="flex-1 w-full bg-obsidian relative overflow-hidden">
      ...
      >
        ...
        <div 
          ...
          style={{
            background: `radial-gradient(400px circle at ${mousePosition.x}px ${mousePosition.y}px, rgba(0, 229, 255, 0.15), transparent 40%)`,
          }}
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-12">
                {[
                  ...
                  <div key={idx} className="relative pl-8">
                    ...
                    <div className="absolute left-[-4px] top-2 w-2 h-2 rounded-full bg-cyan shadow-[0_0_10px_rgba(0,229,255,0.8)]" />
            ...
            >
              <div 
                ...
                style={{
                  background: `radial-gradient(600px circle at ${mousePosition.x - 600}px ${mousePosition.y}px, rgba(139, 92, 246, 0.15), transparent 40%)`,
                }}
              />
