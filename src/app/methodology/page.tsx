    ...
    <main className="flex-1 w-full relative overflow-hidden bg-obsidian py-24 md:py-32">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        ...
        <div className="relative max-w-4xl mx-auto" ref={containerRef}>
          ...
          <motion.div 
            className="absolute left-[39px] md:left-1/2 top-0 w-1 bg-gradient-to-b from-cyan via-amethyst to-cyan -translate-x-1/2 rounded-full shadow-[0_0_15px_rgba(0,229,255,0.5)] z-0"
            ...
            {phases.map((phase, index) => {
              ...
              return (
                <div key={index} className={`flex flex-col md:flex-row items-start gap-8 md:gap-16 ${isEven ? 'md:flex-row-reverse' : ''}`}>
                  ...
                  {/* Timeline Node */}
                  <div className="absolute left-[39px] md:left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-obsidian border-4 border-cyan flex items-center justify-center shadow-[0_0_20px_rgba(0,229,255,0.3)] mt-6 md:mt-0 z-20">
